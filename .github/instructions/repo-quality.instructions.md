...
- Run `composer validate`, `composer run lint:fix`, `composer run lint:all`, `composer run test`, `composer run check`, `composer audit`, and `composer run ci` before commit.
